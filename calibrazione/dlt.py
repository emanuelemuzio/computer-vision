...
def getKR(P):
    ...
    # Normalizziamo K in modo da avere 1 in posizione 3:3
    # Se non facciamo questo possiamo riscontrare dei problemi con l'inversione di K allo step successivo
